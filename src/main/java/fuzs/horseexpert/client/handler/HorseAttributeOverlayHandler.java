...
public class HorseAttributeOverlayHandler {
    ...
    public static void renderHorseAttributeTooltips(Screen screenInstance, PoseStack poseStack, int screenWidth, int screenHeight, AbstractHorse animal) {
        ...
        for (int i = 0; i < tooltipComponents.size(); i++) {
            screenInstance.renderTooltip(poseStack, Lists.newArrayList(TextComponent.EMPTY), tooltipComponents.get(i), posX, posY + 29 * i);
        }
    }
