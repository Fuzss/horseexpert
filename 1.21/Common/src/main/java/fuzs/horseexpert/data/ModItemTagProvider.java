...
public class ModItemTagProvider extends AbstractTagProvider<Item> {
    ...
    public void addTags(HolderLookup.Provider provider) {
        ...
        this.add(TypedTagFactory.ITEM.curios("head")).add(ModRegistry.MONOCLE_ITEM.value());
        this.add(TypedTagFactory.ITEM.trinkets("head/face")).add(ModRegistry.MONOCLE_ITEM.value());
    }
}
