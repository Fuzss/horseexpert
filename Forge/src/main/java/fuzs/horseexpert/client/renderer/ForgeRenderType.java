...
public abstract class ForgeRenderType extends RenderType {
    ...
    private ForgeRenderType(String string, VertexFormat vertexFormat, VertexFormat.Mode mode, int i, boolean bl, boolean bl2, Runnable runnable, Runnable runnable2) {
