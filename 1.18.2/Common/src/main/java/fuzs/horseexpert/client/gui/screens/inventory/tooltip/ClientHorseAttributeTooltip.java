...
public record ClientHorseAttributeTooltip(@Nullable Item item, @Nullable MobEffect icon, Component line1, @Nullable Component line2) implements ClientTooltipComponent {
   ...
   public void renderText(Font font, int posX, int posY, Matrix4f matrix4f, MultiBufferSource.BufferSource multiBufferSource) {
      ...
      font.drawInBatch(this.line1, posX + ICON_SIZE + startX1, posY - FIRST_LINE_HEIGHT, -1, true, matrix4f, multiBufferSource, false, 0, 0xF000F0);
      if (this.line2 != null) {
         font.drawInBatch(this.line2, posX + ICON_SIZE + startX2, posY + 10 - FIRST_LINE_HEIGHT, -1, true, matrix4f, multiBufferSource, false, 0, 0xF000F0);
      }
   }
   ...
   public void renderImage(Font font, int posX, int posY, PoseStack poseStack, ItemRenderer itemRenderer, int blitOffset) {
      if (this.item != null) {
         ...
         itemRenderer.renderAndDecorateItem(new ItemStack(this.item), posX + 2, posY + 1 - FIRST_LINE_HEIGHT);
      ...
      if (this.icon != null) {
         ...
         GuiComponent.blit(poseStack, posX + 1, posY - FIRST_LINE_HEIGHT, blitOffset, 18, 18, atlasSprite);
      }
   }
}